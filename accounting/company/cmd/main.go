...
import (
	...
	"os"
	"os/signal"
	company "piwi-backend-clean/accounting/company/core/usecases"
	handler "piwi-backend-clean/accounting/company/infra/gateways"
	"piwi-backend-clean/accounting/company/infra/persistence"
	"syscall"
)
